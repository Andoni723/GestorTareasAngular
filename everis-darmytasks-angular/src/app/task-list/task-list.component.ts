...
export class TaskListComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    // }
    this.tasks = [
    {id: 1, description: 'Tarea numero uno', status: this.taskStatusOpts[(1%3)].value},
    {id: 2, description: 'Tarea numero dos', status: this.taskStatusOpts[(2%3)].value},
    {id: 3, description: 'Tarea numero tres', status: this.taskStatusOpts[(3%3)].value},
  ];
